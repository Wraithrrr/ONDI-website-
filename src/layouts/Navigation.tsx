    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-3 md:py-4">
        <div className="flex items-center gap-4">
          ...
          <div className="hidden lg:flex flex-1 ml-auto items-center justify-center gap-10 text-xl">
            <button
              type="button"
              onClick={() => goToHash('#/')}
              ...
              <div className="invisible opacity-0 group-hover:visible group-hover:opacity-100 group-hover:translate-y-1 transition-all duration-200 absolute top-full right-0 mt-2 w-72 rounded-lg shadow-xl py-3 bg-white border border-gray-100 z-50">
                {[
                  ...
                  <button
                    ...
                    className="w-full text-left block px-6 py-3 text-lg text-gray-700 cursor-pointer transition-colors hover:bg-[#FFF8E5] hover:text-[#134C28]"
                  >
                    {item.label}
                  </button>
                ))}
      ...
      >
        <div className="px-6 py-4 space-y-3 text-xl">
          <button
            type="button"
            onClick={() => goToHash('#/')}
